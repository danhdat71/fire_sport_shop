...
class CreateProductRequest extends ApiRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'image_1' => 'required|mimes:jpg,jpeg,png,JPG,webp|max:10000',
            'image_2' => 'nullable|mimes:jpg,jpeg,png,JPG,webp|max:10000',
    ...
    public function messages()
    {
        return [
            ...
            'image_1.required' => 'Chưa chọn ảnh đại diện kìa !',
